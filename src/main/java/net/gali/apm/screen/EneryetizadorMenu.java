...
public class EneryetizadorMenu extends AbstractContainerMenu {
    public final EneryetizadorBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public EneryetizadorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ENERYETIZADOR.get());
    }
