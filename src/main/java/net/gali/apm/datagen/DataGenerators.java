...
@Mod.EventBusSubscriber(modid = APMMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        ModBlockTagGenerator blockTagGenerator = generator.addProvider(event.includeServer(), new ModBlockTagGenerator(packOutput,
